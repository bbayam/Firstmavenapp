package com.cybertek.tests.Day17_webTablesTests_day2;
...
public class WebTableTests extends TestBase {
    ...
    /*
    Write a method that will return count of rows
    //in this case, object if by allows us to specify table locator of any type
     */
    ...
    /*
    Write a method that will retyrns number of columns
    ...
    public void countOfColumnsTest1() {
        Assert.assertEquals(getCountOfColumns(), 6, "NUmber of comlumns doesnt match");
    }

    @Test
    public void countOfColumnsTest2() {
        Assert.assertEquals(getCountOfColumns(By.xpath("//table[1]//th")), 6, "NUmber of comlumns doesnt match");
    }
    ...
    Assert.assertEquals(actualSize, expectedSize, "Table size doesnt match");
    }

    @Test
    public void tableSizeTest2(){
        int[] expectedSize = {5,6};
        int [] actualSize = getTableSize(By.xpath("//table[1]//tr"), By.xpath("//table[1]//trh"));
        Assert.assertEquals(actualSize, expectedSize, "Table size doesnt match");
    }


    //write a method that will return table headers as a List
    ...
    public void getHeaderTest(){
        ...
        Assert.assertEquals(getHeadersText(), expectedColumnNames, "Column names dont match");
    }
