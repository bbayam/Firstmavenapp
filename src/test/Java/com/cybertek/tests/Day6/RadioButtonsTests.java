...
public class RadioButtonsTests {
    ...
    public static void Test4(){
        //lets write a test
        //that will make sure that only one radio button is selected
        //step 1 : lets find all radio buttons
        List<WebElement> listOfRadioButtons = driver.findElements(By.xpath("//*[@id=\"blue\"]"));
        //lets create counter to count
