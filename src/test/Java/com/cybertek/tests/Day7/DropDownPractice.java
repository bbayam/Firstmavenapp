...
public class DropDownPractice {
    ...
    public static void test3() {
        ...
        //it has methods that helps to work with dropdown
        Select dropDownSelect = new Select(dropdownState);
    ...
    public static void test4(){
        ...
        //mean find option that has value TX and select it
        dropDownSelect.selectByValue("TX");
        SeleniumUtils.waitPlease(2);
    ...
    public static void test6(){
        WebElement multiSelection = driver.findElement(By.xpath("//*[@id=\"content\"]/select[6]"));
        Select multiSelectionSelect = new Select(multiSelection);
